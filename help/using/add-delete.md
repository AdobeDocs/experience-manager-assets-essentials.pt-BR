...
Para adicionar novos ativos para trabalhar, faça upload de alguns ativos do seu sistema de arquivos local. <!-- TBD: Many of the [common file formats are supported](/help/using/supported-file-formats.md). -->
...
>[!TIP]
>
>Você pode fazer upload de ativos para o repositório DAM diretamente dos aplicativos de desktop da [!DNL Creative Cloud]. Veja como o [[!DNL Assets Essentials] se integra ao [!DNL Adobe Asset Link]](/help/using/integration.md).
