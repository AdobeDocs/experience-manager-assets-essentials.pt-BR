...
* **Uso do armazenamento**: O uso do armazenamento, em gigabytes (GB), para o ambiente Assets Essentials, durante os últimos 30 dias ou 12 meses representados usando um gráfico de barras.
