...
O [!DNL Assets Essentials] fornece opções de edição intuitivas viabilizadas pelo [!DNL Adobe Express]. As ações de edição disponíveis usando o [!DNL Adobe Express] são: Redimensionar imagem, Remover fundo, Cortar imagem e Converter JPEG em PNG.
