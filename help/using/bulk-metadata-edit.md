...
## Edição em massa de metadados de ativos {#how-to-bulk-edit-the-metadata-of-multiple-assets-on-assets-essentials}

Execute essas etapas para editar os metadados de vários ativos em massa de uma só vez:

1. No Assets Essentials, clique em **Ativos**.
...
1. Na página Editar metadados, edite os seguintes campos no painel **Propriedades**:
   ...
   * **Palavras-chave:** adicione termos específicos ou strings de texto que forneçam informações de alto nível sobre os ativos para aprimorar sua visibilidade. Adicione uma palavra-chave e pressione Enter ou Return para adicionar outra palavra-chave à lista.
   * **Tags:** Clique no ![ícone de tags](/help/using/assets/tags-icon.svg) para selecionar tags dentre as opções disponíveis. As tags fornecem informações mais específicas sobre os ativos e aumentam sua visibilidade. As tags já aplicadas aos ativos selecionados são exibidas no painel **Propriedades**. Se você não conseguir encontrar as tags relevantes, crie-as e atribua aos ativos selecionados. Consulte [Gerenciar tags no Assets Essentials](/help/using/tagging-management.md) para obter detalhes sobre como criar e atribuir tags a ativos.
   * Clique em **Salvar** para aplicar as atualizações de metadados acima aos recursos selecionados. Depois de salvas, as palavras-chave e as tags são anexadas, enquanto as informações atualizadas sobre Status, Expiração e Autor substituem as informações existentes.
