...
+ Introdução ao Assets Essentials para admins {#get-started-admins}
...
+ [Filtros de pesquisa personalizados](custom-search-filters.md)
...
+ [Relações do ativo](asset-relations.md)
