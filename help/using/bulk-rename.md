---
title: Renomear ativos individualmente e em massa no  [!DNL Assets Essentials]
description: Saiba como renomear ativos em massa usando a nova interface do Assets (Assets Essentials). Ela oferece a capacidade de renomear vários ativos de uma só vez.
role: User
...
1. Use uma das seguintes maneiras para renomear um ativo ou uma pasta:
   ...
   * Selecione o ativo ou pasta e clique em ![Ícone Renomear](assets/do-not-localize/rename-icon.png) **[!UICONTROL Renomear]** no menu superior.
...
1. [Opcional] Clique no ![ícone de desfazer](assets/do-not-localize/undo.svg) para reverter ou cancelar a última ação executada.

1. Verifique as alterações na coluna [!UICONTROL Nova visualização de nome] e clique em **[!UICONTROL Salvar]**.

   ![Renomeação em massa de IA](assets/ai-bulk-rename.png)
