...
Refaça o processamento dos arquivos em uma pasta se ocorrer uma das duas situações a seguir:

* Você deseja executar uma predefinição de conjunto em lote em uma pasta de ativos existente que já contém ativos carregados.
...
1. Em [!DNL Assets Essentials], na página de Ativos, selecione os ativos recém-adicionados ou os ativos que deseja reprocessar.
...
1. Selecione **[!UICONTROL Reprocessar ativos]**. Escolha entre as duas opções:

   ![Opções de reprocessamento de ativos](assets/reprocessing-options.png)
   ...
   * **[!UICONTROL Avançado]:** selecione esta opção para escolher o reprocessamento avançado.
     ...
     ![Opções avançadas de reprocessamento de ativos](assets/reprocessing-options-advanced.png)
      ...
      * **[!UICONTROL Processamento de perfis]:** escolha esta opção quando quiser reprocessar um perfil selecionado. Você pode escolher a opção **[!UICONTROL Processo completo]** para incluir o processamento padrão e o perfil personalizado atribuído no nível da pasta.
...
>[!NOTE]
>
>Você precisa configurar o [!DNL Dynamic Media] no ambiente para habilitar a caixa de diálogo do Dynamic Media.
>
